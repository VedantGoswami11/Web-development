...
<nav id="nav">
    ...
    <ul>
        ...
        <li><a class="Courses" id="Active" href="sql.php">Courses</a></li>
        <?php 
    ...
    if (isset($_POST['submit-search'])) {
        ...
        if ($queryResult > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="parent_box sql_courses" id="sql_one">
                    <div class="right_column">
                        <h4><a href="https://www.coursera.org/professional-certificates/google-data-analytics"> <?php echo "<p>".$row['c_title']."</p>"; ?></a></h4>
                    ...
                    <div class="left_column">
                        ...
                        <br>
                        <p class="genral_paragraph v2">
                        <?php echo "<p>".$row['c_description']."</p>"; ?>
                        
                            <br>
                            <br>Users: (50,096) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Rating:4.5<span>&#9733</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cost: [FREE!]
                            <br>
                            <br>Language: <?php echo $row['c_language']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Level: <?php echo $row['c_level']; ?>
                        </p>
